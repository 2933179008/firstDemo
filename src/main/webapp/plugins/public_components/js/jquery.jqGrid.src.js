        ...
        return this.each( function() {
            ...
            var sortkeys = ["shiftKey","altKey","ctrlKey"],
                ...
                addMulti = function(rowid,pos,irow,checked){
                    ...
                    v = v + '  <label  for="jqg_'+ts.p.id+'_'+rowid+'" class="check-box"></label> ';
                    return "<td role=\"gridcell\" "+prp+">"+v+"</td>";
                },
            ...
            if(this.p.multiselect) {
                this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' xxx type='checkbox'/><label for='cb_"+this.p.id+"' class='check-box' style='margin:0px;'></label>");
            ...
            $("th",thr).each(function ( j ) {
                ...
                firstr += "<td role='gridcell' style='height:0px;width:"+w+"px;"+hdcol+"' class='"+this.className+ "'></td>";
            ...
            $(ts).before(grid.hDiv).click(function(e) {
                ...
                if(["INPUT","TD"].indexOf(e.target.nodeName) == -1 ||$(ptr).length === 0 || ptr[0].className.indexOf( 'ui-state-disabled' ) > -1 || ($(td,ts).closest("table.ui-jqgrid-btable").attr('id') || '').replace("_frozen","") !== ts.id ) {
                    return this;
                }
            ...
            $(grid.bDiv)
                .append($('<div style="position:relative;float: left;'+(isMSIE && $.jgrid.msiever() < 8 ? "height:0.01%;" : "")+'"></div>').append('<div></div>').append(this))
                    ...
                    buildRuleMenu = function( elem, left, top ){
                        ...
                        for ( i = 0 ; i < options.sopt.length; i++) {
                            ...
                            if(ina !== -1) {
                                ...
                                str += '<li class="ui-menu-item '+selclass+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+p.odata[ina].oper+'" oper="'+p.operands[p.odata[ina].oper]+'"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="32px">'+p.operands[p.odata[ina].oper]+'</td><td>'+ p.odata[ina].text+'</td></tr></table></a></li>';
                            }
                        }
                        str += "</ul>";
                        $('body').append(str);
    ...
    $.jgrid.extend({
        ...
        navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
            o = $.extend({
                ...
                add: true,
                addicon:"ui-icon-plus icon-plus",
                del: true,
    ...
    $.jgrid.extend({
        setSubGrid : function () {
            return this.each(function (){
                var $t = this, cm, i,
                    suboptions = {
                        plusicon : "ui-icon-plus icon-plus",
                        minusicon : "ui-icon-minus icon-minus",
...
// requiere load multiselect before grid
    ...
    $.jgrid.extend({
        ...
        columnChooser : function(opts) {
            ...
            var shade_id ="layui-layer-"+(new Date()).getTime();
            var shade_dom = '<div class="layui-layer-shade" id="'+shade_id+'"  style="z-index:19891015; background-color:#000; opacity:0.3; filter:alpha(opacity=30);"></div>';
            window.top.document.body.append($(shade_dom)[0]);
               ...
               */
               ...
               "done" function */
                "apply_perm" : function() {
                  ...
                  /*  $.each(perm, function() { if( !colModel[parseInt(this,10)] ){cols.push(  ); }         });*/

                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      ...
                      '<input class="input-mini" type="text" name="daterangepicker_start" disabled ="false" value="" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +
                      '<label for="daterangepicker_end"></label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" disabled ="false" value="" />' +
                    '</div>' +
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                this.container.css({
                    ...
                    right: parentRightEdge - this.element.offset().left - this.element.outerWidth(true),
                    left: 'auto'
                });

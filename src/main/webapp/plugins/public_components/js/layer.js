...
function(a, b) {
    ...
    g.pt.auto = function(a) {
        ...
        f = e.config,
        g = c("#" + h[0] + a);
        "" === f.area[0] && f.maxWidth > 0 && (/MSIE 7/.test(navigator.userAgent) && f.btn && g.width(g.innerWidth()), g.outerWidth(true) > f.maxWidth && g.width(f.maxWidth));
        var i = [g.innerWidth(), g.innerHeight()],
        j = g.find(h[1]).outerHeight(true) || 0,
        k = g.find("." + h[6]).outerHeight(true) || 0;
        switch (f.type) {
        case 2:
            b("iframe");
            break;
    ...
    g.pt.offset = function() {
        ...
        b = a.config,
        c = a.layero,
        e = [c.outerWidth(true), c.outerHeight(true)],
    ...
    g.pt.tips = function() {
        ...
        b = a.config,
        e = a.layero,
        f = [e.outerWidth(true), e.outerHeight(true)],
        g = c(b.follow);
        g[0] || (g = c("body"));
        var i = {
    ...
    g.pt.move = function() {
        ...
        function(a) {
            if (a.preventDefault(), "ok" === c(this).attr("move")) {
                ...
                i = e.layero.outerWidth(true) - 6,
                j = e.layero.outerHeight(true) - 6;
        ...
        c(document).mousemove(function(a) {
            if (e.ismove) {
                ...
                if (a.preventDefault(), !b.moveOut) {
                    e.setY = d.scrollTop();
                    var g = d.width() - e.move.outerWidth(true),
                    h = e.setY;
                    0 > c && (c = 0),
                    c > g && (c = g),
                    h > f && (f = h),
                    f > d.height() - e.move.outerHeight(true) + e.setY && (f = d.height() - e.move.outerHeight(true) + e.setY)
                }
                e.move.css({
                    left: c,
                    top: f
    ...
    f.iframeAuto = function(a) {
        if (a) {
            var b = f.getChildFrame("html", a).outerHeight(true),
            d = c("#" + h[0] + a),
            e = d.find(h[1]).outerHeight(true) || 0,
            g = d.find("." + h[6]).outerHeight(true) || 0;
            d.css({
                height: b + e + g
            }),
            d.find("iframe").css({
    ...
    f.style = function(a, b) {
        var d = c("#" + h[0] + a),
        f = d.attr("type"),
        g = d.find(h[1]).outerHeight(true) || 0,
        i = d.find("." + h[6]).outerHeight(true) || 0; (f === e.type[1] || f === e.type[2]) && (d.css(b), f === e.type[2] && d.find("iframe").css({

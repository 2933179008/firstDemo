    ...
    <form id="materielManagerForm" class="form-horizontal" style="overflow: auto; height: calc(100% - 70px);">
        ...
        <div class="row" style="margin:0;padding:0;">
                    ...
                    <c:if test="${depotPosition.id==null}">
                        <div class="input-append span12 required">
                            <input type="text" class="span11" id="positionCode" name="positionCode" placeholder="库位编码"
                                    style="width: calc(100% - 70px);" value="${depotPosition.positionCode}"/>
                        </div>
                    </c:if>
                    <c:if test="${depotPosition.id!=null}">
                        <div class="input-append span12 required">
            ...
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    <div class="input-append span12 required">
                        <input type="text" class="span11" id="positionName" name="positionName" style="width: calc(100% - 70px);"
        ...
        <div class="row" style="margin:0;padding:0;">
            ...
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    <div class="input-append span12 required">
                        <input type="text" class="span11" id="row" name="row" value="${depotPosition.row}" style="width: calc(100% - 70px);"
                               placeholder="排">
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin:0;padding:0;">
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    <div class="input-append span12 required">
                        <input type="text" class="span11" id="column" name="column" value="${depotPosition.column}" style="width: calc(100% - 70px);"
                               placeholder="列">
                    </div>
                </div>
            </div>
            ...
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    <div class="input-append span12 required">
                        <input type="text" class="span11" id="layer" name="layer" value="${depotPosition.layer}" style="width: calc(100% - 70px);"
                               placeholder="层">
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin:0;padding:0;">
            ...
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    <div class="input-append span12 required">
                        <input type="text" class="span11" id="capacityRfidAmount" name="capacityRfidAmount" style="width: calc(100% - 70px);"
        ...
        <div class="row" style="margin:0;padding:0;">
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    <div class="input-append span12 required">
                        <input type="text" class="span11" id="capacityWeight" name="capacityWeight" style="width: calc(100% - 70px);"
        ...
        <div class="row" style="margin:0;padding:0;">
            ...
            <div class="control-group span6" style="display: inline">
                ...
                <div class="controls">
                    ...
                    <textarea type="text" class="span11" id="remark" name="remark" value="${depotPosition.remark}" style="width: calc(100% - 44px);"
...
<script type="text/javascript">
    ...
    $("#materielManagerForm").validate({
        rules: {
            ...
            "positionCode": {
                ...
                maxlength: 16,
                <c:if test="${depotPosition.id==null}">
                remote: context_path + "/erpDepotPositionManage/hasC?id=" + $('#id').val()
                </c:if>
            },
            /*库位名称*/
            "positionName": {
    ...
    function saveTaskDetail() {
        ...
        if ($("#materielManagerForm" +
            ...
            $.ajax({
                url: context_path + "/erpDepotPositionManage/addDepotPosition?tm=" + new Date(),
                type: "POST",
                data: roleParam,
                dataType: "JSON",

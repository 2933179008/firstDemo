...
<div id="platform_edit_page" class="row-fluid" style="height: inherit;">
	<form id="materielManagerForm" class="form-horizontal" style="overflow: auto; height: calc(100% - 70px);">
		...
		<div class="control-group">
			<label class="control-label" for="">物料条码：</label>
			<div class="controls">
				<div class="input-append span12 required">
					<input type="text" class="span11" id="" name="" value=""  placeholder="物料条码">
				</div>
			</div>
		</div>

		<div class="control-group">
			<label class="control-label" for="">库区：</label>
			<div class="controls">
				<div class="input-append span12 required">
					<input type="text" class="span11" id="" name="" value=""  placeholder="库区">
				</div>
			</div>
		</div>

		<div class="control-group">
			<label class="control-label" for="">不良品类型：</label>
			<div class="controls">
				<div class="input-append span12 required">
					<select id="" name=""  style="width:91%;">
						<option value="0">请选择</option>
						<option value="1">退换物料</option>
						<option value="2">返修品</option>
		...
		<div class="control-group">
			<label class="control-label" for="">出/入库时间：</label>
			<div class="controls">
				<div class="input-append span12required">
					<input class="form-control date-picker span11" id="" name="" value="" type="text" placeholder="生产日期" />
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append span12required">
					<textarea type="text" id="" name="" value="" placeholder="备注" class="span11"></textarea>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label" for="">责任人：</label>
			<div class="controls">
				<div class="input-append span12 required">
					<select id="" name=""  style="width:91%;">
						<option value="0">请选择</option>
						<option value="1">吕德</option>
						<option value="2">李虎</option>
						<option value="3">赵恩</option>
					</select>
				</div>
			</div>
		</div>

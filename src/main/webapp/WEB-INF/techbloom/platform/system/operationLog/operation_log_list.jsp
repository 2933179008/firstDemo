...
<div id="grid-div">
    <form id="hiddenQueryForm" style="display:none;">
        <input id="operationTimeId" name="operationTime" value="">
    </form>
			 ...
			 <ul class="form-elements">
				<li class="field-group field-fluid2">
					<label class="inline" for="operationTime" style="margin-right:20px;width:100%;">
						...
						<input class="form-control date-picker" id="operationTime" name="operationTime" style="width: calc(60% );" type="text" placeholder="操作时间" />
					</label>
				</li>
			</ul>
...
_grid = jQuery("#grid-table").jqGrid({
				url : context_path + "/operationLog/list.do",
			    datatype : "json",
			    colNames : ["主键","操作人","操作内容","动作","操作时间"],
			    colModel : [
			                 {name : "id", index: "id", hidden: true},
			                 {name : "username",index : "username",width:55,sortable:false},
			                 {name : "operation",index : "operation",width : 100},
			                 {name : "useraction",index : "useraction",width: 60,formatter:function(LogActionConstant){
                                     if(LogActionConstant == "1"){
                                         return "<span style='color:blue;font-weight:bold;'>用户登录</span>";
                                     } else if (LogActionConstant == "2") {
                                         return "<span style='color:green;font-weight:bold;'>用户添加</span>";
                                     } else if (LogActionConstant == "3") {
                                         return "<span style='color:red;font-weight:bold;'>用户编辑</span>";
                                     } else if (LogActionConstant == "4") {
                                         return "<span style='color:deeppink;font-weight:bold;'>用户删除</span>";
                                     } else if (LogActionConstant == "5") {
                                         return "<span style='color:orangered;font-weight:bold;'>用户查询</span>";
                                     } else if (LogActionConstant == "6") {
                                         return "<span style='color:darkseagreen;font-weight:bold;'>用户导出</span>";
                                     } else if (LogActionConstant == "7") {
                                         return "<span style='color:darkolivegreen;font-weight:bold;'>用户退出</span>";
                                     } else if (LogActionConstant == "8") {
                                         return "<span style='color:black;font-weight:bold;'>设备删除</span>";
                                     }else {
                                         return "<span style='color:yellow;font-weight:bold;'>TODO</span>";
                                     }
                                 }},
			                 {name : "operationT",index : "operationT",width : 60}
			               ],
			    rowNum : 20,
			    rowList : [ 10, 20, 30 ],
			    pager : "#grid-pager",

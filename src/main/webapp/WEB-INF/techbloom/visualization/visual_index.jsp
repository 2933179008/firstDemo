...
<div class="card-body" style="height: calc(100% - 10px);padding:10px 10px 0;">
    ...
    <div class="tab-content" style="height: calc(100% - 70px);">
        <div id="content1" class="p-relative h-100 w-100 rotate rotate270deg">
            <div class="p-absolute-auto a-right">
                ...
                <div class="border_visual_row p-absolute a_01-20 flex-row align-items-center justify-content-between a-12 materielBySorts">
                    ...
                    <span class="drawer rotate180deg" id="A12"></span>
                </div>
            ...
            <div class="p-absolute-auto a-down">
                ...
                <div class="border_visual_row p-absolute a_63-66 flex-row align-items-center justify-content-between a-63 materielBySorts">
                    <span class="rotate180deg">A63</span>
                    <span class="drawer rotate180deg" id="A63"></span>
                </div>
                <div class="border_visual_row p-absolute a_63-66 flex-row align-items-center justify-content-between a-64 materielBySorts">
...
<script>
    ...
    function getCarPosition() {
        $.ajax({
            url: context_path + "/visual/getCarPosition?areaId=" + $("#tabs").val(),
            type: "post",
            dataType: "JSON",
            success: function (data) {
                $(".truck").remove();
    ...
    // truckPosition(10.31,26.91,29.702,48.812,"KQ0000001","1",true);//小车的坐标，x=10.31,y=26.91,A库区的坐标范围是（29.702，48.812）,"A"表示A库区，"1"表示第一个小车，true表示车上有货，第二个图标。
    // truckPosition(18.61,20.11,29.702,48.812,"KQ0000001","2",false);//小车的坐标，x=10.31,y=26.91,A库区的坐标范围是（29.702，48.812）
    // truckPosition(16.61,11.11,29.702,48.812,"KQ0000001","3",true);//小车的坐标，x=10.31,y=26.91,A库区的坐标范围是（29.702，48.812）
    //
    // truckPosition(14.61,40.216,29.692,44.518,"KQ0000002","1",true);//小车的坐标，x=14.61,y=40.216,B库区的坐标范围是（29.692，44.518）
    // truckPosition(15.98,20.216,29.692,44.518,"KQ0000002","2",false);//小车的坐标，x=15.98,y=20.216,B库区的坐标范围是（29.692，44.518）
    //
    // truckPosition(14.61,15.25,29.66,25.7,"KQ0000003","1",false);//小车的坐标，x=14.61,y=15.25,C库区的坐标范围是（29.66，25.7）
    // truckPosition(5.61,20.95,29.66,25.7,"KQ0000003","2",true);//小车的坐标，x=5.61,y=20.95,C库区的坐标范围是（29.66，25.7）

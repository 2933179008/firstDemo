...
<div id="grid-div-c">
    <div class="row-fluid" id="table_toolbar" style="padding:5px 3px;">
        <button class=" btn btn-primary btn-editQx" onclick=" materielPowerRfidTransfer();">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(window).on("resize.jqGrid", function () {
            ...
            $("#grid-table-c").jqGrid("setGridHeight",  $(".container-fluid").height()-$("#yy-c").outerHeight(true)-$("#fixed_tool_div-c").outerHeight(true)-$("#grid-pager-c").outerHeight(true)
                -$("#gview_grid-table .ui-jqgrid-hdiv").outerHeight(true)-100);
        });
    ...
    //货权转移
    function materielPowerRfidTransfer() {
        var id = jQuery("#grid-table-c").jqGrid('getGridParam', 'selarrrow');
        //获取行数据
        var rowData = $('#grid-table-c').jqGrid('getRowData', id);
        ...
        if (checkedNum == 0) {
            ...
            $.post(context_path + "/stockQuery/toTransferRfidView?id=" + id, {}, function (str) {

...
<script type="text/javascript">
    ...
    $(function () {
        _grid_c = jQuery("#grid-table-c").jqGrid({
            url: context_path + "/movePosition/getDetailList?movePositionId="+${movePositionId},
            datatype: "json",
            colNames: ["主键", "物料编码","物料名称","批次号","包装","数量","重量（kg）","RFID"],
            colModel: [
                ...
                {name: "batchRule", index: "batchRule", width: 50,sortable: false},
